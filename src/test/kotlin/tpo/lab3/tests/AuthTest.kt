...
class AuthTest: BehaviorSpec(), BaseTest {
    ...
    lateinit var profilPage: ProfilePage
    ...
    init {
        ...
        Given("Пользователь заходит на страницу авторизации") {
            ...
            When("пользователь вводит правильный логин и пароль") {
                Then("AUTH-1: после ввода логина и пароля открывается профиль") {
            ...
            When("пользователь вводит не email и пароль") {
                Then("AUTH-2: авторизация не происходит и пользователь остаётся на странице /auth") {
            ...
            When("пользователь вводит не правильный логин и пароль") {
                Then("AUTH-3: авторизация не происходит и пользователь остаётся на странице /auth") {
            ...
            When("пользователь вводит правильный логин и не правильный пароль") {
                Then("AUTH-4: авторизация не происходит и пользователь остаётся на странице /auth") {
            ...
            When("Пользователь аутентифицировался и нажал кнопку выйти") {
                Then("AUTH-5: пользователь попал на домашнюю страницу") {
                    authPage.waitUntilOpened()
